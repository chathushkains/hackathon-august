...
export default function RegisterForm({ onClose, onSwitchToLogin }) {
  ...
  return (
    <div className="modal-backdrop flex items-center justify-center p-4 z-50">
      <div className="modal-content w-full max-w-md max-h-[90vh] overflow-y-auto scale-in">
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full btn-accent py-4 text-base disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
